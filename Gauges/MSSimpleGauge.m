...
- (void)setupArcLayers
{
    ...
    _backgroundArcLayer.strokeColor = UIColorFromRGB(0xf2f2f2);
    _backgroundArcLayer.fillColor = UIColorFromRGB(0xf2f2f2);
...
- (void)fillUpToAngle:(float)angle
{
    if ( _valueArcLayer )
    {
        ...
        if (_value == 5) {
            ...
            _fillArcFillColor = UIColorFromRGB(0xd30203);
            _fillArcStrokeColor = UIColorFromRGB(0xd30203);
        } else {
            _fillArcFillColor = UIColorFromRGB(0x249500);
            _fillArcStrokeColor = UIColorFromRGB(0x249500);
        }
        _valueArcLayer.fillColor = _fillArcFillColor;
        _valueArcLayer.strokeColor = _fillArcStrokeColor;
    }
